...
<div className="hidden md:flex w-full h-full items-center justify-between px-4 md:px-0 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-6">
            <h4 className='cursor-pointer hover:text-[#6d34ad] text-[#4B4453] font-semibold'><Link to={'home'}>Home</Link></h4>

            <h5 className='cursor-pointer hover:text-[#6d34ad] text-[#4B4453] font-semibold'><Link to={'about'}>About us</Link></h5>
